#!/bin/bash
# Pretrain script for LLaVA-Qwen (Qwen + External ViT)
...
OUTPUT_DIR="./outputs/llava_pretrain"
...
echo "=========================================="
echo "LLaVA-Qwen Pretrain (Projector Training)"
echo "=========================================="
...
DEFAULT_RUN_NAME="llava_qwen_pretrain"
