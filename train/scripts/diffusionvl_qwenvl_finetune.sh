...
# --- Optional: NAVIDA jsonl (DiffusionVL LazyNavidaJsonlDataset) ---
# Point DATA_PATH at your .jsonl (e.g. navida_train_data_r2r.jsonl). If every frame path
# in the file is absolute, IMAGE_FOLDER can stay as a dummy (e.g. ".") and is ignored.
# Add these flags to the torchrun block below (after --image_folder):
#   --dataset_format navida_jsonl \
#   --navida_max_history_frames 8 \

# Output directory
# TODO: Set your output directory
OUTPUT_DIR="./outputs/diffusionvl_qwenvl_finetune"
...
num_node=$1
gpu_num=$2
custom_run_name=${3:-"diffusionvl_qwenvl_finetune"}
