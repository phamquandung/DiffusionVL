#!/bin/bash
# Finetune script for LLaVA-Qwen model
# Model type: llava_qwen (External ViT + Qwen LLM, standard AR)
...
OUTPUT_DIR="./outputs/llava_qwen_finetune"
...
num_node=$1
gpu_num=$2
custom_run_name=${3:-"llava_qwen_finetune"}
...
echo "=========================================="
echo "LLaVA-Qwen Finetune (Standard AR)"
echo "=========================================="
